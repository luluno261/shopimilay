  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold">Outils de Capture de Leads</h2>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-gray-50 rounded-lg shadow-md p-6">
          <h3 className="text-xl font-semibold mb-4">Pop-ups</h3>
          ...
          {loading ? (
            ...
            <div className="space-y-2">
              {popups.map((popup) => (
                <div key={popup.id} className="border border-gray-200 rounded p-3 bg-white">
        ...
        <div className="bg-gray-50 rounded-lg shadow-md p-6">
          <h3 className="text-xl font-semibold mb-4">Barres d'annonce</h3>
          <p className="text-gray-600 mb-4">
